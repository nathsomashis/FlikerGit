			...
			<div class="slogan">
				...
				<div class="tp-banner-container">
					<div class="tp-banner" >
						<ul>
							<!-- SLIDE  -->
							<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb='<c:url value="/resources/img/slider/homeslider_thumb1.jpg" />' data-saveperformance="on"  data-title="Intro Slide">
								<!-- MAIN IMAGE -->
								<img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="slidebg1" data-lazyload='<c:url value="/resources/img/slider/slidebg1.jpg" />' data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								<!-- LAYERS -->
								...
								style="z-index: 2;"><img src="<%=request.getContextPath()%>/resources/img/slider/plate2.png" alt="" data-lazyload='<%=request.getContextPath()%>/Resource/img/slider/plate2.png"'>
								</div>
								...
								data-elementdelay="0.1"
								data-endelementdelay="0.1"
								style="z-index: 3;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload='<%=request.getContextPath()%>/resources/img/slider/plate1.png"'>
								</div>
								...
								data-elementdelay="0.1"
								data-endelementdelay="0.1"
								style="z-index: 4;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload='<%=request.getContextPath()%>/resources/img/slider/woman1.png"'>
								</div>
								...
								<div class="tp-caption customin rs-parallaxlevel-0"
									...
									data-elementdelay="0.1"
									data-endelementdelay="0.1"
									style="z-index: 6;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/redbg.png">
								</div>
								...
								data-elementdelay="0.1"
								data-endelementdelay="0.1"
								style="z-index: 11;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/greyline.png">
								</div>
								...
								style="z-index: 13;">
									...
									data-ye="0"
									>
										<img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-ww="18" data-hh="11" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/doublearrow2.png">
									</div>
								</div>
							</li>
							<!-- SLIDE  -->
							<li data-transition="slideleft" data-slotamount="7" data-masterspeed="2000" data-thumb="<%=request.getContextPath()%>/resources/img/slider/homeslider_thumb2.jpg" data-delay="10000"  data-saveperformance="on"  data-title="Slide">
								<!-- MAIN IMAGE -->
								<img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png"  alt="laptopmockup_sliderdy" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/laptopmockup_sliderdy.jpg" data-bgposition="right top" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
								<!-- LAYERS -->
								...
								<div class="tp-caption customin fadeout rs-parallaxlevel-10"
									...
									data-endelementdelay="0.1"
									data-endspeed="300"
									style="z-index: 2;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload='<c:url value="/resources/img/slider/redbg_big.png" />'>
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="300"
								style="z-index: 8;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-ww="17" data-hh="17" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/check.png">
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="300"
								style="z-index: 11;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-ww="17" data-hh="17" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/check.png">
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="300"
								style="z-index: 14;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-ww="17" data-hh="17" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/check.png">
								</div>
							</li>
							<!-- SLIDE  -->
							<li data-transition="zoomin" data-slotamount="7" data-masterspeed="1500" data-thumb="<%=request.getContextPath()%>/resources/img/slider/homeslider_thumb4.jpg"  data-saveperformance="on"  data-title="Mobile Interaction">
								<!-- MAIN IMAGE -->
								<img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png"  alt="slidebg1" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/slidebg1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								<!-- LAYERS -->
								...
								data-endelementdelay="0.1"
								data-endspeed="300"
								style="z-index: 2;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/ipad2.png">
								</div>
								...
								style="z-index: 3;">
									...
									data-zoomend="1"
									>
										<img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/pulse1.png">
									</div>
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="300"
								style="z-index: 5;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/iphone.png">
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="600"
								style="z-index: 7;"><img src="<%=request.getContextPath()%>/resources/img/slider/dummy.png" alt="" data-lazyload="<%=request.getContextPath()%>/resources/img/slider/largegreen.png">
								</div>
			...
			<div class="row">
		        ...
		        <div class="col-xs-12 col-sm-6 col-md-3">
		            <div class="panel panel-primary pricing-big">
		            	<img src="img/ribbon.png" class="ribbon" alt="ribbon">
		                <div class="panel-heading">
		                    <h3 class="panel-title">
		                        Developer Bundle</h3>
		                </div>
