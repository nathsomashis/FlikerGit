									...
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-addon">School Name</span> <input
												...
												placeholder="School Name" type="text" name="course" 
												id="schoolname">
										</div>
										<div class="input-group">
											<span class="input-group-addon">Reason to Open School</span> <textarea class="form-control" 
											id="schooldescription" name="reason" rows="3"></textarea>
										</div>
									</div>
											...
											<div class="widget-toolbar hidden-phone">
												<div class="smart-form">
													<label class="checkbox">
														<button class="btn btn-primary" data-toggle="modal" data-target="#addmembers" >Add Members</button>
														</label>
												</div>
											</div>
