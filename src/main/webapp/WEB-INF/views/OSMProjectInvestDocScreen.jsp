			...
			<div id="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Total Investment</span> <input
									class="form-control input-lg"
									placeholder="Total Investment" type="text" name="course"
					...
					<div class="col-sm-12">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Minimum Stake Amount</span> <input
									class="form-control input-lg"
									placeholder="Minimum investment amount or multiple of it.." type="text" name="course"
									id="projectname"><span class="input-group-addon">$</span>
					...
					<div class="col-sm-12">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Stock Amount</span> <input
									class="form-control input-lg"
									placeholder="Stock Amount" type="text" name="category"
									id="category">
					...
					<div class="col-sm-12">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Stock Price Punch</span> <input
									class="form-control input-lg"
									placeholder="Punch the Stock Price(U can change later or it will change according to demand)" type="text" name="course"
									id="projectname"><span class="input-group-addon">$</span>
				...
				<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Investment Link</span> <input
													class="form-control input-lg"
													placeholder="Please provide any investment site or url from your side" type="text" name="investmentlink"
													id="investmentlink">
												...
												<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-0" data-widget-editbutton="false">
													...
													<div>
														...
														<div class="widget-body">
															...
															<form action="upload.php" class="dropzone" id="dropboxinvest"></form>
