							...
							<div class="tab-pane fade in active" id="s1">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
										<!-- sparks -->
										<button class="btn btn-primary" data-toggle="modal" data-target="#createnew">Setting Selling Params</button>
										<!-- end sparks -->
									</div>
									<!-- end col -->
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="projectname">Setting the Sell params: </h4>
						</div>
