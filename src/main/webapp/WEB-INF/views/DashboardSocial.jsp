	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="hello?name=Eric?">Home</a></li><li>Social Wall</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-retweet"></i> Social Wall </h1>
					</div>
					<!-- end col -->
