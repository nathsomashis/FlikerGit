					...
					<div class="col-sm-12">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Article Heading</span> <input
									class="form-control input-lg"
									placeholder="Article Heading" type="text" name="course"
									id="articlename"><span class="input-group-addon">$</span>
