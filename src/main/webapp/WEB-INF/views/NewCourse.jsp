	...
	<body class="">
				...
				<ul>
					...
					<li class="active">
						...
						<ul>
							...
							<li class="active">
								<a href="createcourse?" title="NewCourse"><i class="fa fa-plus-square txt-color-red"></i><span class="menu-item-parent">NEWCOURSE</span></a>
							</li>
							<li class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="hello?name=Eric?">Home</li><li>Course</li><li>New Course</li>
				</ol>
				<!-- end breadcrumb -->
