	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="<%=request.getContextPath()%>/resources/img/logo.png" alt="SmartAdmin"> </span>
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="<%=request.getContextPath()%>/resources/img/avatars/sunny.png" alt="John Doe" class="online" />  
						</a>
