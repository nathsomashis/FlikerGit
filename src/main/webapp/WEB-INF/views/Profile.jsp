		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					...
					<li class="active">
						<a href="profile?"><i class="fa fa-lg fa-fw fa-info txt-color-red"></i> <span class="menu-item-parent">PROFILE</span> <span class="badge pull-right inbox-badge margin-right-13">14</span></a>
					</li>
					<li>
