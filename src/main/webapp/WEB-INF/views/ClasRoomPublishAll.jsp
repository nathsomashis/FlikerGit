			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<ul id="myTab1" class="nav nav-tabs bordered">
						...
						<li><a href="#s4" data-toggle="tab">On Going ClassRoom</a></li>
							...
							-->
											...
											<div class="widget-toolbar">
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu js-status-update pull-right">
														<li><a href="javascript:void(0);" id="mt2">Month</a></li>
														<li><a href="javascript:void(0);" id="ag2">Agenda</a>
														</li>
														<li><a href="javascript:void(0);" id="td2">Today</a></li>
													</ul>
												</div>
											</div>
											</header>
											...
											<div>
												...
												<div class="widget-body no-padding">
													...
													<div class="widget-body-toolbar">
														...
														<div id="calendar2-buttons">

															<div class="btn-group">
																<a href="javascript:void(0)"
																	class="btn btn-default btn-xs" id="btn-prev2"><i
																	class="fa fa-chevron-left"></i></a> <a
																	href="javascript:void(0)"
																	class="btn btn-default btn-xs" id="btn-next2"><i
																	class="fa fa-chevron-right"></i></a>
															</div>
														</div>
													</div>
