			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<ul id="myTab1" class="nav nav-tabs bordered">
						<li class="active"><a href="#s1" data-toggle="tab">MyCourses<i
								class="fa fa-caret-down"></i></a></li>
						<li><a href="#s2" data-toggle="tab">Create New Course</a></li>
					...
					<div class="col-sm-9">
						...
						<div class="well padding-10">
							//your courses directly goes to CoursesOnly page
							<div class="row">
								<div class="col-md-4">
							...
							<hr>
							//directly goes to CourseDetails page.
							<div class="row">
								<div class="col-md-4">
