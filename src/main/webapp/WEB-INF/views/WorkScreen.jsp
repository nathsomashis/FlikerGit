		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					...
					<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#corporateValiate">
											Job Provider
										</button>
					<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#consumerValidate">
											Job Seeker
										</button>					
			...
			<!-- END MAIN CONTENT -->
			<div class="modal fade" id="corporateValiate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="modal fade" id="consumerValidate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
