							...
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<div class="well padding-10">
										...
										ArrayList schoollist = (ArrayList)request.getAttribute("schoollist");
										...
										for(int m=0;m<schoollist.size();m++){
											...
											HashMap schoolmap = (HashMap)schoollist.get(m);
											Set perschool = schoolmap.entrySet();
											Iterator periter = perschool.iterator();
											System.out.println("fghdfdf1");
											while (periter.hasNext()) {
												Map.Entry perschoolme = (Map.Entry) periter.next();
												String keyvalue = (String) perschoolme.getKey();
												
												if (keyvalue.equalsIgnoreCase("schoolid")) {
													schoolid = (String)perschoolme.getValue();
												}else if (keyvalue.equalsIgnoreCase("schoolname")) {
													schoolname = (String)perschoolme.getValue();
												}else if (keyvalue.equalsIgnoreCase("schoolduration")) {
													schoolduration = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("guidancelinks")) {
													BasicDBList guidancelinks = (BasicDBList)perme.getValue();
													for(int f=0;f<guidancelinks.size();f++){
														
													}
												}else if (keyvalue.equalsIgnoreCase("courselinks")) {
													BasicDBList courselinks = (BasicDBList)perme.getValue();
													for(int k=0;k<courselinks.size();k++){
														
													}
												}else if (keyvalue.equalsIgnoreCase("schooldesc")) {
													schooldesc = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("studentnumber")) {
													studentnumber = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("schoollocation")) {
													schoollocation = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("schoolimage")) {
													schoolimage = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("studentnumber")) {
												...
												}else if (keyvalue.equalsIgnoreCase("likes")) {
													likes = (String)perme.getValue();
												}else if (keyvalue.equalsIgnoreCase("share")) {
													share = (String)perme.getValue();
												}
