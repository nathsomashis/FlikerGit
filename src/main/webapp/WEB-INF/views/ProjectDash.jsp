	...
	<body class="">
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
		<li class="active"><a href="projectdash?"><span
				class="menu-item-parent">Dashboard</span> </a></li>
		<li><a href="projectcalendar?"> <span
				class="menu-item-parent">Calendar</span> </a></li>
		<li><a href="projectblog?"><span class="menu-item-parent">Discussion</span> </a></li>
		<li><a href="projecttimeline?"><span class="menu-item-parent">Timeline</span> </a></li>
		<li><a href="projectdrive?" title="NewPost"><span class="menu-item-parent">Share Drive</span></a></li>
		<li><a href="projectplanning?" title="NewPost"><span class="menu-item-parent">Project Planning</span></a>
		</li>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="hello?name=Eric?">Home</li><li>DashBoard</li>
				</ol>
				<!-- end breadcrumb -->
