...
<html lang="en-us">
	...
	<body class="">
		...
		<li class="active"><a href="#" title="Dashboard"><i
				class="fa fa-lg fa-fw fa-book txt-color-blue"></i> <span class="menu-item-parent">Course</span></a>
			<ul>
				<li class=""><a href="mycourse?" title="NewPost"><i
						class="fa fa-tags"></i><span class="menu-item-parent">My Course</span></a>
				</li>
				<li class="active"><a href="courseanalysis?" title="NewJob"><i
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="hello?name=Eric?">Home</li><li>Course</li><li>Course Analysis</li>
				</ol>
				<!-- end breadcrumb -->
