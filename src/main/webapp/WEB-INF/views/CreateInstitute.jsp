					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="#" class="header-search pull-right">
									<input id="searchparam"  type="text" name="param" placeholder="Find reports and more" >
				 ...
				 $.getJSON('searchOnGuidanceSubject?guidancesubject='+guidancesub, function(dataset) {
		        	// console.log(dataset);
		        	 ...
		        	 /* for(var x=0;x<dataset.length;x++){
		        		 ...
		        		 var name;
		        		 var currentstatus;
		        		 $.getJSON('getProfileInfoBasic?user='+user, function(dataset) {
		        		 
		        			 console.log(dataset);
		        			 name = dataset.name;
		        			 currentstatus = dataset.currentStatus;
		        			 
		        		 });
		        		 var location = dataset[x].guidancelocation;
		        		 var interest = dataset[x].guidanceinterest;
		        		 var duration = dataset[x].guidanceduration;
		        		 var price = dataset[x].price;
