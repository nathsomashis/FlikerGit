...
<body class="">
	...
	<div id="main" role="main">
		...
		<div id="content">
							...
							<div class="well well-sm">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Organization Name</span> <input
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Organization Focus</span>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Organization EmailID</span> <input
													class="form-control input-lg"
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Organization SkypeID</span> <input
													class="form-control input-lg"
													placeholder="First Name" type="text" name="category"
													id="category">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
											 	<span class="input-group-addon">About Organization</span>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Organization HangoverID</span>
												<input class="form-control input-lg"
													placeholder="Course Description" type="text"
													name="coursedescription" id="coursedescription">
																		...
																		<div class="tabs-left">
																			<ul class="nav nav-tabs tabs-left" id="demo-pill-nav">
																				<li class="active"><a href="#tab-r1"
																					data-toggle="tab">
																						Organization Image</a></li>
																				<li><a href="#tab-r2" data-toggle="tab">
																						Organization Supporting Images</a></li>
			...
			<hr class="simple">
			<h3>Course/Specialization Tabs
			<br>
			<small>Click button to add another Course/Specialization</small></h3>
			...
			<div id="tabs2">
				<ul>
					<li>
						<a href="#tabs-1">Course/Specialization Name</a>
					</li>
				</ul>
				<div id="tabs-1">
					<p>
