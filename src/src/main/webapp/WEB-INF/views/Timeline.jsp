		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					...
					<li class="active">
						<a href="timeline?"><i class="fa fa-lg fa-fw fa-road txt-color-pink"></i> <span class="menu-item-parent">TIMELINE</span> <span class="badge pull-right inbox-badge margin-right-13">14</span></a>
					</li>
					<li>
